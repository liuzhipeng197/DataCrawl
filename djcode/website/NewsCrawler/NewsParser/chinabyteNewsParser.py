...
class chinabyteNewsParser():
	def __init__(self):
		pass

	def newsparser(self,soup,url,now_time):
	    '''
		...
		news['source'] = source
		news['logo'] = logo
		news['addtime'] = str(time.localtime().tm_hour)+":"+str(time.localtime().tm_min)
